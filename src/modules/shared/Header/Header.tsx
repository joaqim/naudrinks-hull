...
export interface HeaderProps {
  //data: S.HeaderSettings & {promo: S.PromoSettings}
  data: {
    promo: S.PromoSettings
    menuDesktopLeft: S.Menu
    menuDesktopRight: S.Menu
    menuMobilePrimary: S.Menu
    menuMobileSecondary: S.Menu
  }
  isTransparent?: boolean
  classes?: string
}

const Header = ({ data, classes = '', isTransparent = false }: HeaderProps) => {
  const {
    promo,
    menuDesktopLeft,
    menuDesktopRight,
              ...
              <div className="logo">
                <Link href="/" scroll={false}>
                  <a className="logo--link" aria-label="Go Home">
                    <Icon name="Logo" id="header" viewBox="0 -30 195 130" />
                  </a>
                </Link>
              </div>
